...
html_theme_options = {
    ...
    "theme_color": "3f51b5",
    # sphinx-material's built-in version switcher: it fetches versions.json
    # (generated by docs/gen_versions_json.py after a multiversion build)
    # relative to the site root and renders a dropdown in the header.
